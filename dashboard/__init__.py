...
- main_dashboard: Main application entry point
"""

__version__ = "1.0.0"
__author__ = "Social Media Tracker Team"
__description__ = "Japanese Music Trends Dashboard powered by DBT and Streamlit"
