# filepath: /home/florent.bossart/code/florent-bossart/social_media_tracker/dags/llm_youtube_processing_dag.py
import os
    ...
    run_youtube_pipeline = BashOperator(
        ...
        bash_command=f"""
            ...
            poetry run python data_pipeline/run_complete_pipeline.py \\
                --input {{{{ dag_run.conf.get(\'input_file\', \'/opt/airflow/projects/social_media_tracker/data/intermediate/20250528_full_youtube_comments_cleaned_nllb_translated.csv\') }}}} \\
